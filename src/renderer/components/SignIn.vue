			...
			<span class="section_right">
				<div class="section_right_div" v-if="stepPassworld == '1'">
					...
					<span class="section_right_div_span2">
					 ...
					 <el-button type="primary" size="medium" :disabled="dengluChecked" style="width: 100%;" @click='denglu' id="dengluID"  :loading="signInLoading">登录</el-button>
				...
				<div class="section_right_div" v-if="stepPassworld == '2'">
					...
					<span class="section_right_div_span1">
							...
							<span>					    	
								...
								<el-button size="mini" type="primary" style="height: 30px;padding: 7px 7px;" v-show="newTextFlage == '2'" @click="getVerifyingCode" :loading="newTextLoading">获取验证码</el-button>
					...
					<el-button type="primary" size="medium"  style="width: 100%;margin-top: 50px;margin-left: 0;" @click="modifyFun2" v-show="modifyBtn2" :loading="modifyFun2loading">确定</el-button>
					...
					<div class="section_right_div" v-if="stepPassworld == '3'">
									...
									<el-button type="primary" size="medium"  style="width: 100%;margin-top: 50px;margin-left: 0;" @click="modifyFun3" v-show="modifyBtn3">确定</el-button>
...
<script>
	...
	import { login , get , post , patch , put } from './api'
...
// 					 }
        ...
        login('/music/api-token-auth/',send_data).then( res => {
				...
				.catch(function(error){
					   _this.signInLoading = false;
						var str = error.data.non_field_errors[0] == "Unable to log in with provided credentials." ? "密码错误" : error.data.non_field_errors[0];
						 console.log()
						 _this.$message({
											showClose:true,
											message:str,
